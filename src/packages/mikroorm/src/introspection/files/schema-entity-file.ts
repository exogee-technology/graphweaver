...
export class SchemaEntityFile extends BaseFile {
	...
	generate(): string {
		...
		const isPrimaryKeyAutoGenerated = primaryKey.autoincrement || primaryKey.generated || (primaryKey.defaultRaw && primaryKey.defaultRaw !== 'null');

		if (isSinglePrimaryKeyEntity || !isPrimaryKeyAutoGenerated || this.clientGeneratedPrimaryKeys) {
