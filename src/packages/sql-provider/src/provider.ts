import { BackendProvider, PaginationOptions } from '@exogee/base-resolver';
import { logger } from './logger';
import { Database } from './database';
import { FilterQuery, LockMode, QueryFlag, ReferenceType, Utils } from '@mikro-orm/core';
...
export class MikroBackendProvider<T> implements BackendProvider<T> {
	...
	public async update(id: string, updateArgs: Partial<T & { version?: number }>): Promise<T> {
	...
	public async create(createArgs: Partial<T>): Promise<T> {
