		...
		<>
			...
			<div className={styles.wrapper}>
				<div className={styles.errorBox}>
					...
					<Spacer height={10} />
					<p>
						If you are a developer, this is likely a problem in a custom field or page. It could
						also be a problem in Graphweaver itself. If you believe this is a Graphweaver bug,
						please{' '}
						<a
