...
export type _Entity = ApiKey | CaseStudy | Credential | DeprecatedProduct | Inventory | NonResolvableEntity | Product | ProductDimension | ProductResearch | ProductVariation | Token | User;
