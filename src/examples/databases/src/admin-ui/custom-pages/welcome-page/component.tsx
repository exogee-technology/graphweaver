...
export const WelcomePage = () => (
    ...
    tasks(filter: {user: {username_in: ["mike_jones", "jane_smith"]}}) {
		...
		/>
		<p className={styles.text}>
			Graphwaever does something really special. It will go to the Postgres database, find user IDs
		...
		<p className={styles.text}>Graphweaver can do this for all of your data sources.</p>
	</>
);
