...
export type ProfitAndLossRowsQuery = {
	__typename?: 'Query';
	profitAndLossRows: Array<{
		__typename?: 'ProfitAndLossRow';
		amount: number;
		date: any;
		tenant?: { __typename?: 'Tenant'; id: string; tenantName: string } | null;
	}>;
};
 ...
 * });
 */
export function useProfitAndLossRowsQuery(
	baseOptions: Apollo.QueryHookOptions<ProfitAndLossRowsQuery, ProfitAndLossRowsQueryVariables>
) {
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useQuery<ProfitAndLossRowsQuery, ProfitAndLossRowsQueryVariables>(
		ProfitAndLossRowsDocument,
		options
	);
}
export function useProfitAndLossRowsLazyQuery(
	baseOptions?: Apollo.LazyQueryHookOptions<ProfitAndLossRowsQuery, ProfitAndLossRowsQueryVariables>
) {
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useLazyQuery<ProfitAndLossRowsQuery, ProfitAndLossRowsQueryVariables>(
		ProfitAndLossRowsDocument,
		options
	);
}
...
export type ProfitAndLossRowsQueryResult = Apollo.QueryResult<
	ProfitAndLossRowsQuery,
	ProfitAndLossRowsQueryVariables
>;
