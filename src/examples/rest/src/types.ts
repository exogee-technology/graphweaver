 ...
 */
export type ResultOf<T> = T extends DocumentTypeDecoration<infer ResultType, infer VariablesType>
	? ResultType
	: never;
 ...
 */
export type VariablesOf<T> = T extends DocumentTypeDecoration<infer ResultType, infer VariablesType>
	? VariablesType
	: never;
